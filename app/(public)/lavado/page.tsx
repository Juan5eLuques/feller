         ...
         <div className="container mx-auto px-4">
                  ...
                  return (
                     ...
                     >
                        ...
                        >
                           ...
                           <Button className="w-full cursor-pointer" variant={service.popular ? "default" : "outline"}>
                              Reservar Turno
                           </Button>
                        </Card>
                     </motion.div>
            ...
            >
               <Card className="inline-block p-8 bg-card border-border">
                  ...
                  <Button variant="outline" className="cursor-pointer">Contactar para Cotización</Button>
               </Card>
            </motion.div>
         </div>
      </section>
